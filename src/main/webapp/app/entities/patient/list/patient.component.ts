...
export class PatientComponent implements OnInit {
  ...
  searchPatient(event: any): void {
    ...
    this.patientService.searchPatient({ text: event.target.value, query: '' }).subscribe((res: any) => {
      this.patients = res.body;
    });
  }

  delete(patients: IPatient): void {
    const modalRef = this.modalService.open(PatientDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.patient = patients;
