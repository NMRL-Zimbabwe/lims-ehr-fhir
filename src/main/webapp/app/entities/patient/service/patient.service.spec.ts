...
describe('Patient Service', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpPatientTestingModule],
    });
    expectedResult = null;
  ...
  describe('Service methods', () => {
    ...
    describe('addDeveloperToCollectionIfMissing', () => {
      it('should add a Developer to an empty array', () => {
        const client: IPatient = sampleWithRequiredData;
      ...
      it('should not add a Developer to an array that contains it', () => {
        const client: IPatient = sampleWithRequiredData;
        const developerCollection: IPatient[] = [
          {
            ...client,
          },
      ...
      it("should add a Developer to an array that doesn't contain it", () => {
        const client: IPatient = sampleWithRequiredData;
        const developerCollection: IPatient[] = [sampleWithPartialData];
        expectedResult = service.addDeveloperToCollectionIfMissing(developerCollection, client);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(client);
      });
      ...
      it('should add only unique Developer to an array', () => {
        const developerArray: IPatient[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const developerCollection: IPatient[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const client: IPatient = sampleWithRequiredData;
        const developer2: IPatient = sampleWithPartialData;
