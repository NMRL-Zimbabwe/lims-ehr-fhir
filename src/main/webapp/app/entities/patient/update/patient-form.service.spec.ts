  ...
  describe('Service methods', () => {
    describe('createPatientFormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createPatientrFormGroup();
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            primary_referrer: expect.any(Object),
            primary_referrer_id: expect.any(Object),
    ...
    describe('getPatient', () => {
      it('should return NewDeveloper for default Patient initial value', () => {
