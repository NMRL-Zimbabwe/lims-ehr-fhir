...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof zw.org.nmr.limsehr.service.EmailAlreadyUsedException ||
            ex instanceof zw.org.nmr.limsehr.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof zw.org.nmr.limsehr.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "zw.org.nmr.limsehr");
    }
}
